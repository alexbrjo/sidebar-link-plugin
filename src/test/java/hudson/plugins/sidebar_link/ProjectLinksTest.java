...
public class ProjectLinksTest {
    ...
    public void testGetJobActionsDoesNotReturnNull() throws Exception{
        ...
        JobLinks links = new JobLinks(null);
        assertNotNull("Method getJobActions should not return null.", links.getJobActions(project));
        //from gui
    ...
    public void testLinkActionIsAddedWithJobProps () throws Exception{
        ...
        p1.addProperty(new JobLinks(Collections.singletonList(new LinkAction("http://google.com","stop","edit-delete.png"))));
        assertEquals(1, p1.getActions(LinkAction.class).size());

        Job p2 = rule.jenkins.createProject(WorkflowJob.class, "ernie");
        p2.addProperty(new JobLinks(Collections.singletonList(new LinkAction("http://giggle.com","stop","edit-delete.png"))));
